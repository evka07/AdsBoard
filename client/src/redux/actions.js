...
export const fetchAds = () => {
    return dispatch => {
        ...
        return axios.get('https://33ca8d42-a622-46a0-ad13-29ee4cbf4f9a-00-39p4s9c49d0qy.janeway.replit.dev/ads')
            .then(response => {
...
export const createAd = (adData) => {
    return dispatch => {
        ...
        return axios.post('https://33ca8d42-a622-46a0-ad13-29ee4cbf4f9a-00-39p4s9c49d0qy.janeway.replit.dev/ads/create', adData)
            .then(response => {
...
export const updateAd = (id, adData) => {
    return dispatch => {
        ...
        return axios.put(`https://33ca8d42-a622-46a0-ad13-29ee4cbf4f9a-00-39p4s9c49d0qy.janeway.replit.dev/ads/${id}`, adData)
            .then(response => {
...
export const deleteAd = (id) => {
    return dispatch => {
        ...
        return axios.delete(`https://33ca8d42-a622-46a0-ad13-29ee4cbf4f9a-00-39p4s9c49d0qy.janeway.replit.dev/ads/${id}`)
            .then(response => {
...
export const loginUser = (username, password) => {
    return dispatch => {
        ...
        return axios.post('https://33ca8d42-a622-46a0-ad13-29ee4cbf4f9a-00-39p4s9c49d0qy.janeway.replit.dev/login', { username, password })
            .then(response => {
...
export const registerUser = (username, password) => {
    return dispatch => {
        ...
        return axios.post('https://33ca8d42-a622-46a0-ad13-29ee4cbf4f9a-00-39p4s9c49d0qy.janeway.replit.dev/register', { username, password })
            .then(response => {
